...
Sam J. developer for power automate and create projects and add users

next week wednesday

## Upgraded Reports3 K8s Cluster

- Switching from MySQL stateful set to MySQL operator
- Setup K8s rephub cluster at home. Ligtel giving me 64k slice of v6 addresses.  Should be able to work on Teams tab with Ligtel IP.
